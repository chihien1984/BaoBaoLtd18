...
{
    public partial class frmChildNodeStages : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmChildNodeStages(string sanphamid, string maloai,
        ...
        //Thể hiện danh sách sản phẩm Mã sản phẩm | tên sản phẩm
        ...
        private void frmChildNodeStages_Load(object sender, EventArgs e)
        {
            ...
            TheHienCongDoanSanPham();//Thể hiện danh sách sản phẩm Mã sản phẩm | tên sản phẩm
            TheHienDanhSachCongDoanTheoSanPhamID();//Thể hiện công đoạn sản phẩm theo ID
            ShowStagesCode();//
        ...
        private void TheHienCongDoanMacDinh()
        {
            ...
            string sqlQuery = string.Format(
				...
				'1' SoChiTiet,''DienGiai,Ma_Nguonluc,N'Cái'DonVi from tblResources
        ...
        {
            //Tạo mới công đoạn rỗng
            TheHienCongDoanMoi();
        }
        private void TheHienCongDoanMoi()
        {
            ketnoi kn = new ketnoi();
            string sqlQuery = string.Format(@"select top 0 '{0}'+'/CD00' MaLoai,
                Ten_Nguonluc,''DinhMuc,ToThucHien,ThuTu,
				'1' SoChiTiet,''DienGiai,Ma_Nguonluc,''DonVi 
